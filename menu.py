        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    print(f"{menu_selection} isnt in our menu. ")
...
for item in order_list:
    ...
    num_item_spaces = 26 - len(item_name)  # 24 -> 26 to account for the pipe spacing
    item_spaces = " " * num_item_spaces 
    num_price_spaces = 6 - len(str(item_price))  # 8 -> 6 to account for the pipe and dollar sign
    price_spaces = " " * num_price_spaces
    num_quantity_spaces = 10 - len(str(item_quantity))  # 12 -> 10 to match header
    quantity_spaces = " " * num_quantity_spaces

    # 9. Print with adjusted spacing and pipes
